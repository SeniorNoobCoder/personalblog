...
//            zTree.setting.check.chkboxType = { "Y" : "ps", "N" : "ps" };
        ...
        $(document).ready(function(){
            var treeNodes = '';
            $.ajax({
                url : "${pageContext.request.contextPath}/partners/partners/findServerCategory.do?user_id=${pd.user_id}",
                data : {},
                type : 'GET',
                dataType : 'json',
...
<div align="center">
    ...
    <a class="btn btn-mini btn-danger" onclick="art.dialog.opener.saveSuccess();">关闭</a>
</div>
</body>
</html>
