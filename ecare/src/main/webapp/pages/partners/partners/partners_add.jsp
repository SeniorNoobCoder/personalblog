            ...
            $("#cdForm").validate({
                rules: {
                    login_name: {
                        ...
                        rangelength:[4,18],
                        remote: {
                            url: "${pageContext.request.contextPath}/partners/partners/checkLoginName.do",     //后台处理程序
                            type: "post",               //数据发送方式
...
<body>
<form action="${pageContext.request.contextPath}/partners/partners/save.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
        ...
        <div id="zhongxin">
            <table width="90%">
                <tr>
                    ...
                    <td><input type="text" name="login_name" id="login_name" value="${partnersInfo.login_name }" placeholder="这里输入登录名称" title="登录名称" onchange="changeLoginName('${partnersInfo.login_name }')"/></td>
                </tr>
                <tr>
                ...
                <%--<tr>--%>
                    ...
                    <%--<td><input type="text" name="company_name" id="company_name" value="${partnersInfo.company_name }" placeholder="这里输入公司名称" title="公司名称"/></td>--%>
                <%--</tr>--%>
                <tr>
                    <td width="20%" align="right">联系人名称：</td>
                    <td><input type="text" name="user_name" id="user_name" value="${partnersInfo.user_name }" placeholder="这里输入联系人名称" title="联系人名称"/></td>
                </tr>
                <tr>
                    <td width="20%" align="right">电子邮箱：</td>
                    <td><input type="text" name="email" id="email" value="${partnersInfo.email }" placeholder="这里输入电子邮箱" title="电子邮箱"/></td>
                </tr>
                <tr>
                    <td width="20%" align="right">联系方式：</td>
                    <td><input type="text" name="phone" id="phone" value="${partnersInfo.phone }" placeholder="这里输入联系方式" title="联系方式"/></td>
                </tr>
                <%--<tr>--%>
                    <%--<td width="20%" align="right">合作商类型：</td>--%>
                    <%--<td>--%>
                        <%--<select style="width:100%;" name="type" id="type">--%>
                            <%--<c:forEach items="${dictionaryList}" var="v">--%>
                                <%--<option value="${v.id}" <c:if test="${v.id==p.type}"> selected="selected" </c:if>>${v.name}</option>--%>
                            <%--</c:forEach>--%>
                        <%--</select>--%>
                    <%--</td>--%>
                <%--</tr>--%>
                <tr>
					...
					<td><img alt="" src="${partnersInfo.head_url }" style="width: 80px;height: 80px;margin-bottom:10px;"><br/>
					<input type="file" name="head_address" id="head_address" value="${partnersInfo.head_address }"/></td>
				</tr>
                <%--<tr>--%>
                    <%--<td width="20%" align="right">排序：</td>--%>
                    <%--<td><input type="text" name="order_by" id="order_by" value="${partnersInfo.order_by }" placeholder="这里输入排序" title="排序"/></td>--%>
                <%--</tr>--%>
                <tr>
                    <td width="20%" align="right">备注：</td>
                    <td>
                       <textarea rows="2" cols="8" name="remark" id="remark">${partnersInfo.remark }</textarea>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center;" colspan="2">
                    	<input type="hidden" id="submit_type" name="submit_type" value="">
                    	<input type="hidden" id="id" name="id" value="${partnersInfo.id }">
                        <input type="text" id="step" name="step" value="${partnersInfo.step }">
                        <%--<a class="btn btn-mini btn-primary" onclick="save('save');">保存</a>--%>
                        <a class="btn btn-mini btn-primary" onclick="save('save_next');">下一步</a>
