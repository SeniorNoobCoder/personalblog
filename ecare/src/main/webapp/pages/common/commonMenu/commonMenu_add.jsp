...
<c:if test="${pd.flag == 'toadd' }">
		<div id="zhongxin">
   		<form action="${pageContext.request.contextPath}/common/commonMenu/save.do" name="cdForm" id="cdForm" method="post">
		<table width="90%">
			<tr>
			...
			<tr>
				<td style="text-align: center;" colspan="2">
					...
					<input type="hidden" name="classify" value="${pd.classify }"/>
