...
<script type="text/javascript">
	...
	$(document).ready(function (){
		var treeNodes = '';
			$.ajax({
			    url : "${pageContext.request.contextPath}/common/commonMenu/findList.do?classify=${pd.classify }",
			    data : {},
			    type : 'GET',
			    dataType : 'json',
	...
	function show(id,name){
		...
		if(type=="menu"){
			$.ajax({
	            type: "POST",
	            url: "${pageContext.request.contextPath}/common/commonMenu/findList.do?classify=${pd.classify }&parent_id="+id+'&type='+type,
	            dataType: "json",
