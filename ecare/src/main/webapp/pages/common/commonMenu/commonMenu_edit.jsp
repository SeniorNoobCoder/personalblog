...
<html lang="en">
  ...
  <body>
<c:if test="${pd.flag == 'toedit' }">
		<div id="zhongxin">
   		<form action="${pageContext.request.contextPath}/common/commonMenu/update.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
		<table width="90%">
			<tr>
			...
			<tr>
				...
				<td><input type="text" id="name" name="name" value="${pd.name }" style="width: 95%" placeholder="这里输入菜单名称" title="菜单名称"/></td>
			</tr>
			<tr>
				<td width="20%" align="right">编码：</td>
				<td><input type="text" id="code" name="code" value="${pd.code }" style="width: 95%" placeholder="这里输入编码" title="编码"/></td>
			</tr>
			<tr>
				<td width="20%" align="right">链接：</td>
				<td><input type="text" name="url" id="url" value="${pd.url }" style="width: 95%" placeholder="这里输入链接" title="链接"/></td>
			</tr>
			<tr>
				<td width="20%" align="right">排序：</td>
				<td><input type="number" name="order_by" id="order_by" value="${pd.order_by }" style="width: 95%" placeholder="这里输入序号" title="序号"/></td>
			</tr>
			<tr>
				<td width="20%" align="right">备注：</td>
				<td>
					<textarea rows="3" cols="8" name="remark" id="remark"  style="width:95%;">${pd.remark }</textarea>
				</td>
			</tr>
			<tr>
