...
<html lang="en">
  ...
  <body>
    <form action="${pageContext.request.contextPath}/common/commonRole/update.do" name="roleForm" id="roleForm" method="post">
		<c:if test="${pd.flag ne 'update'}">
		<div id="zhongxin">
		<input type="hidden" value="${pd.id}" name="id">
		<table width="90%">
			<tr>
				<td width="20%" align="right">角色名称：</td><td><input type="text" name="name" id="name" value="${pd.name }" style="width: 95%" placeholder="这里输入角色名称 " title="角色名称"/></td>
			</tr>
			<tr>
				<td width="20%" align="right">角色简称：</td><td><input type="text" name="short_name" id="short_name"  value="${pd.short_name }"  style="width: 95%" placeholder="这里输入角色简称 " title="角色简称"/></td>
			</tr>
			
			<tr>
				<td width="20%" align="right">排序：</td>
				<td><input type="number" name="order_by"  id="order_by" value="${pd.order_by }" style="width: 95%" placeholder="这里输入排序" title="排序"/></td>
			</tr>
			<tr>
				<td width="20%" align="right">备注：</td>
				<td>
					<textarea rows="5"  style="width: 95%;resize: none;" name="remark" id="remark">${pd.remark}</textarea>
				</td>
			</tr>
			<tr>
