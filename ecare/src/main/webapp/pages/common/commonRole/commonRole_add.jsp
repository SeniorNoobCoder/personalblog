...
<html lang="en">
  ...
  <body>
    <form action="${pageContext.request.contextPath}/common/commonRole/save.do" name="roleForm" id="roleForm" method="post">
		...
		<table width="90%">
			...
			<tr>
				<td style="text-align: center;" colspan="2">
					<input type="hidden" id="classify" name="classify" value="${pd.classify }">
