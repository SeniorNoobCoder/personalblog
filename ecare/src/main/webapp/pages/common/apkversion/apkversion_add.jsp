...
<html lang="en">
  ...
  <body>
    <form action="${pageContext.request.contextPath}/common/apkVersion/save.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
		...
		<table width="90%">
			...
			<tr>
				...
				<td><input type="text" name="content" id="content" placeholder="这里输入版本信息" title="版本信息"/></td>
			</tr>
			<tr>
				<td width="20%" align="right">版本编号：<span style="color:#FF0000">*</span></td>
				<td><input type="text" name="version_code" id="version_code" placeholder="这里输入版本编号" title="版本编号"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="file" name="file_address" id="file_address" placeholder="这里输入版本文件" title="版本文件"/></td>
			</tr>
			<tr>
