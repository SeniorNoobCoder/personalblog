  ...
  <body>
		<table width="90%">
			<tr>
				...
				<td><input type="text" name="sn" id="sn" value="${p.sn }" readonly="readonly" style="width: 95%" placeholder="这里输入设备编号" title="设备编号"/></td>
			</tr>
			<tr>
				<td width="20%" align="right">第三方凭证(APP_ID)：<span style="color:#FF0000">*</span></td>
				<td><input type="text" name="app_id" id="app_id" value="${p.app_id }" readonly="readonly" style="width: 95%" placeholder="这里输入单位名称" title="单位名称"/></td>
			</tr>
			<tr>
				<td width="20%" align="right">设备密钥：</td>
				<td><input type="text" name="secret" id="secret" value="${p.secret }" readonly="readonly" style="width: 95%" placeholder="这里输入设备密钥" title="设备密钥"/></td>
			</tr>
			<tr>
