...
//			      },
  ...
  <body>
    <form action="${pageContext.request.contextPath}/customer/device/update.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
		<c:if test="${pd.label!='b'}">
		<div id="zhongxin">
		<table width="90%">
			<tr>
				<td width="20%" align="right">设备编号：<span style="color:#FF0000">*</span></td>
				<td><input type="text" name="sn" id="sn" value="${p.sn }" style="width: 95%" placeholder="这里输入设备编号" title="设备编号"/></td>
			</tr>
			<%--<tr>--%>
				<%--<td width="20%" align="right">第三方凭证(APP_ID)：<span style="color:#FF0000">*</span></td>--%>
				<%--<td><input type="text" name="app_id" id="app_id" value="${p.app_id }" style="width: 95%" placeholder="这里输入单位名称" title="单位名称"/></td>--%>
			<%--</tr>--%>
			<%--<tr>--%>
				<%--<td width="20%" align="right">设备密钥：</td>--%>
				<%--<td><input type="text" name="secret" id="secret" value="${p.secret }" style="width: 95%" placeholder="这里输入设备密钥" title="设备密钥"/></td>--%>
			<%--</tr>--%>
			<tr>
