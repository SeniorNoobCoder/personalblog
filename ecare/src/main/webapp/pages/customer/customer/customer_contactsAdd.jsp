...
<html lang="en">
  ...
  <body>
    <form action="${pageContext.request.contextPath}/customer/customer/saveContacts.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
		<c:if test="${pd.label!='b'}">
		<div id="zhongxin">
		<table width="90%">
			<tr>
				<td width="20%" align="right">联系人姓名：<span style="color:#FF0000">*</span></td>
				<td><input type="text" name="name" id="name" style="width: 95%" placeholder="这里输入联系人姓名" title="联系人姓名"/></td>
			</tr>
			<tr>
                <td width="20%" align="right">联系方式：</td>
                <td><input type="text" name="mobile" id="mobile" style="width: 95%" placeholder="这里输入联系方式" title="联系方式"/></td>
            </tr>
            <tr>
