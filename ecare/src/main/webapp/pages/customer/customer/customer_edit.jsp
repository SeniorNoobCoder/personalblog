...
<html lang="en">
  ...
  <body>
    <form action="${pageContext.request.contextPath}/customer/customer/update.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
		<c:if test="${pd.label!='b'}">
		<div id="zhongxin">
		<table width="90%">
			<tr>
				<td width="20%" align="right">客户姓名：<span style="color:#FF0000">*</span></td>
				<td><input type="text" name="name" id="name" value="${p.name }" style="width: 95%" placeholder="这里输入客户姓名" title="客户姓名"/></td>
			</tr>
			<tr>
			...
			<tr>
                ...
                <td>
                    <input type="text" name="health_condition" id="health_condition" value="${p.health_condition }" style="width: 95%" placeholder="这里输入用户身体状况" title="身体状况" />
                </td>
            </tr>
			<tr>
            ...
            <tr>
                ...
                <td>
                    <input class="timepicker"  type="text" name="birthday" id="birthday" value="${p.birthday }" style="width: 95%" placeholder="这里输入用户生日" title="用户生日" readonly/>
                </td>
            </tr>    
            <tr>
                <td width="20%" align="right">家庭住址：</td>
                <td>
                    <input type="text" name="address" id="address" value="${p.address }" style="width: 95%" placeholder="这里输入家庭住址" title="家庭住址"/>
                </td>
            </tr>
            <tr>
                <td width="20%" align="right">头像地址：</td>
                <td><img alt="" src="${p.head_address }" style="width: 80px;height: 80px;margin-bottom: 10px;">
					<input type="file" name="head_address" id="head_address" value="${p.head_address}" style="width: 95%"/></td>
            </tr>
			<tr>
