...
<html lang="en">
            ...
            $("#cdForm").validate({
                rules: {
                    login_name: {
                        ...
                        rangelength:[4,18],
                        remote: {
                            url: "${pageContext.request.contextPath}/customer/family/checkLoginName.do",     //后台处理程序
                            type: "post",               //数据发送方式
  ...
  <body>
    <form action="${pageContext.request.contextPath}/customer/family/save.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
		<c:if test="${pd.label!='b'}">
		<div id="zhongxin">
		<table width="90%">
			<tr>
                <td width="20%" align="right">登录名称：</td>
                <td><input type="text" name="login_name" id="login_name" style="width: 95%" placeholder="这里输入登录名称" title="登录名称"/></td>
            </tr>
            <tr>
                <td width="20%" align="right">登录密码：</td>
                <td><input type="password" name="login_password" id="login_password" style="width: 95%" placeholder="这里输入登录密码" title="登录密码"/></td>
            </tr>
            <tr>
                <td width="20%" align="right">用户名称：</td>
                <td><input type="text" name="user_name" id="user_name" style="width: 95%" placeholder="这里输入用户名称" title="用户名称"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input class="timepicker"  type="text" name="birth_date" id="birth_date" style="width: 95%" placeholder="这里输入用户生日" title="用户生日" readonly/>
                </td>
            </tr>    
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="live_address" id="live_address" style="width: 95%" placeholder="这里输入居住地区" title="居住地区"/></td>
            </tr>
            <tr>
                <td width="20%" align="right">出生地址：</td>
                <td><input type="text" name="birth_address" id="birth_address" style="width: 95%" placeholder="这里输入出生地址" title="出生地址"/></td>
            </tr>
            <tr>
