...
<html lang="en">
  ...
  <body>
    <form action="${pageContext.request.contextPath}/customer/family/update.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
		<c:if test="${pd.label!='b'}">
		<div id="zhongxin">
		<table width="90%">
			<tr>
                <td width="20%" align="right">登录名称：</td>
                <td><input type="text" name="login_name" id="login_name" value="${p.login_name }" style="width: 95%" placeholder="这里输入登录名称" title="登录名称"/></td>
            </tr>
            <tr>
