    ...
    <div id="main-content" class="clearfix">
        ...
        <div id="page-content" class="clearfix">
            <div class="row-fluid">
                <div class="row-fluid">
                    <!-- 检索  -->
                    <form action="${pageContext.request.contextPath}/order/order/findWarningList.do?am=${mPd.am }&bm=${mPd.bm }" method="post" name="userForm" id="userForm">
                                                ...
                                                <c:forEach items="${userList}" var="var" varStatus="vs">
                                                    <tr ondblclick="findInfo('${var.id }')">
                                                        ...
                                                        <td>
                                                            ...
                                                            <c:if test="${var.status == '1'}">已下单(即将超时)</c:if>
                                                        </td>
                                                        ...
                                                        <td id="exclude_1_${var.id }">
                                                            ...
                                                            <c:if test="${var.status == '-1'}">
                                                                <%--<a class='btn btn-mini btn-success' title="重新提交" onclick="updateOrder('${var.id }','${var.order_no}');"><i class='icon-share-alt'></i></a>--%>
...
//        isinitVal:true,
    ...
    //取消订单
    function updateOrder(id,orderNo){
        bootbox.confirm("确定要取消该数据?", function(result) {
            if(result) {
