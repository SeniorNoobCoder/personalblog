...
<head>
    ...
    <script type="text/javascript">
        ...
        function save(){
            //url 默认是根据电话记录添加
            var url = "${pageContext.request.contextPath}/order/order/saveVisitingByCall.do";
            var addType = "${pd.addType}";
            if(addType == "customer"){//根据用户记录添加订单
                url = "${pageContext.request.contextPath}/order/order/saveVisitingByCustomer.do";
            }
            if (! $("#cdForm").valid()) {
                return;
            }
    ...
    <form name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
        <div id="zhongxin">
            ...
            <table id="infoTable" class="table table-striped table-bordered table-hover">
                <tr>
                    <td rowspan="4" width="150px"><img alt="" src="${customer.head_address }" style="width: 120px;"></td>
            ...
            <div id="showTitle">回访信息</div>
            <table width="90%">
                <tr>
                    <td width="20%" align="right" id="headTitle">回访内容：</td>
                    <td>
