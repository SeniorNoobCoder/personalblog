    ...
    <div id="main-content" class="clearfix">
        ...
        <div id="page-content" class="clearfix">
            <div class="row-fluid">
                <div class="row-fluid">
                    <!-- 检索  -->
                    <form action="${pageContext.request.contextPath}/order/order/findListByUserId.do?am=${mPd.am }&bm=${mPd.bm }" method="post" name="userForm" id="userForm">
                        <div class="page-header position-relative">
                            <table>
                                <tr>
                                    ...
                                    <%--<td><input type="text" name="create_time" id="create_time" value="${pd.create_time }" placeholder="请选择日期" style="width:100px;"/></td>--%>
                                    <td>
                                                ...
                                                <c:forEach items="${userList}" var="var" varStatus="vs">
                                                    <tr ondblclick="findInfo('${var.id }')">
                                                        ...
                                                        <td>
                                                            ...
                                                            <c:if test="${var.order_source == 'fmily'}">家人快速下单</c:if>
                                                        ...
                                                        <%--<td id="exclude_1_${var.id }">--%>
                                                            <%--<c:if test="${fn:contains(power,'telemarketer_del')&& var.status == '1'}">--%>
                                                                <%--<a class='btn btn-mini btn-warning' title="取消订单" onclick="cancelOrder('${var.id }','${var.order_no}');"><i class='icon-reply'></i></a>--%>
                                                            <%--</c:if>--%>
                                                            <%--<c:if test="${fn:contains(power,'telemarketer_del')&& var.status == '0'}">--%>
