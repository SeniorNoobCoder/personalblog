...
<body>
<form action="${pageContext.request.contextPath}/callCenter/telemarketer/update.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
                    ...
                    <td>
                        <select style="width:100%;" name="wearth_city_id" id="wearth_city_id">
                            ...
                            <c:forEach items="${dictionaryList}" var="v">
                                <option value="${v.id}" <c:if test="${p.wearth_city_id eq v.id}">selected="selected"</c:if>>${v.name}</option>
                            </c:forEach>
                        </select>
                    </td>
                </tr>
