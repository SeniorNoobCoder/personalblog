	...
	<c:if test="${pd.label!='add'}">
		<form action="${pageContext.request.contextPath}/system/organize/save.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
			...
			<table width="90%">
				...
				<tr>
					<td width="20%" align="right">组织名称：</td><td><input type="text" name="name" id="name" style="width: 95%" placeholder="这里输入组织名称" title="组织名称"/></td>
				</tr>
				<tr>
					<td width="20%" align="right">组织简称：</td><td><input type="text" name="short_name" id="short_name" style="width: 95%" placeholder="这里输入组织简称" title="组织简称"/></td>
				</tr>
				<tr>
