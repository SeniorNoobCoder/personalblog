...
<script type="text/javascript">
	...
	$(document).ready(function (){
		var treeNodes = '';
			$.ajax({
			    url : "${pageContext.request.contextPath}/system/organize/dustbintreefindList.do",
			    data : {},
			    type : 'GET',
			    dataType : 'json',
			    success : function(json) {
				   treeNodes += "[{id:'0',parent_id:'parent',name:'公司分管领导'},";
	...
	function show(id){
		$.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/system/organize/dustbintreefindList.do?parent_id="+id,
            dataType: "json",
