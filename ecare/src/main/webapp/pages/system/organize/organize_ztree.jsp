...
<script type="text/javascript">
		...
		var treeNodes = '';
			$.ajax({
			    ...
			    success : function(json) {
				   treeNodes += "[{id:'0',parent_id:'parent',name:'公司分管领导',level:'0',org_cascade:''},";
	...
	function show(id){
		$.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/system/organize/treefindList.do?parent_id="+id,
            dataType: "json",
