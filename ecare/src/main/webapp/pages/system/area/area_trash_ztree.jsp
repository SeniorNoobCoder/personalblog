...
<script type="text/javascript">
	...
	$(document).ready(function (){
		var treeNodes = '';
			$.ajax({
			    url : "${pageContext.request.contextPath}/system/area/findListZtree.do?remove_logo=Y",
			    data : {},
			    type : 'GET',
			    dataType : 'json',
	...
	function show(id){
		$.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/system/area/findListZtree.do?id="+id+"&remove_logo=Y",
            dataType: "json",
