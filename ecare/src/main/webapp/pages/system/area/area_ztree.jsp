...
<script type="text/javascript">
	...
	$(document).ready(function (){
		var treeNodes = '';
			$.ajax({
			    url : "${pageContext.request.contextPath}/system/area/findListZtree.do?remove_logo=N",
			    data : {},
			    type : 'GET',
			    dataType : 'json',
			    success : function(json) {
				   treeNodes += "[{id:'0',parent_id:'parent',name:'地区管理',type:'lx_0'},";
	...
	function show(id){
		$.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/system/area/findListZtree.do?parent_id="+id+"&remove_logo=N",
            dataType: "json",
