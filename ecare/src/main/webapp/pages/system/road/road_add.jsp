			  ...
			  $("#cdForm").validate({
				    ...
				    messages: {
				      ...
				      order_by: {
			      		    ...
			      		    main_mileage:{
			      		    required:"<span style='color:red'>请输入主线里程。</span>",
			      		   number: "<span style='color:red'>请输入正确的数字。</span>"},
				    curing_mileage:{
				      required:"<span style='color:red'>请输入养护里程。</span>",
				    number:"<span style='color:red'>请输入正确的数字。</span>"},
...
<body>
		<form action="${pageContext.request.contextPath}/system/road/save.do" name="cdForm" id="cdForm" method="post">
			<div id="zhongxin">
			<table width="90%">
			<tr>
				...
				<tr>
					<td width="20%" align="right">所属资产：</td>
					<td>
				...
				<tr>
					<td width="20%" align="right">位置：</td><td><input type="text" name="position" id="position" style="width: 95%" placeholder="这里输入位置" title="位置"/></td>
				</tr>
				<tr>
					<td width="20%" align="right">路线编号：</td><td><input type="text" name="road_code" id="road_code" style="width: 95%" placeholder="这里输入路线编号" title="路线编号"/></td>
				</tr>
				<tr>
					<td width="20%" align="right">路线名称：</td><td><input type="text" name="road_name" id="road_name" style="width: 95%" placeholder="这里输入路线名称" title="路线名称"/></td>
				</tr>
					<tr>
					<td width="20%" align="right">道路类型：</td>
					<td>
					<select name="road_type" id="road_type" style="width: 99%">
					<option disabled="disabled" selected="selected">请选择</option>
					<c:forEach items="${roadList}" var="var">
					<option value="${var.id }">${var.name }</option></c:forEach>
					</select>
					</td>
				</tr>
				<tr>
					<td width="20%" align="right">起始桩号：</td><td><input type="text" name="start_stake" id="start_stake" style="width: 95%" placeholder="这里输入起始桩号" title="起始桩号"/></td>
				</tr>
				<tr>
					<td width="20%" align="right">结束桩号：</td><td><input type="text" name="end_stake" id="end_stake" style="width: 95%" placeholder="这里输入结束桩号" title="结束桩号"/></td>
				</tr>
					<tr>
					<td width="20%" align="right">主线里程(km)：</td><td><input type="text" name="main_mileage" id="main_mileage" style="width: 95%" placeholder="这里输入主线里程" title="主线里程"/></td>
				</tr>
				<tr>
					<td width="20%" align="right">养护里程(km)：</td><td><input type="text" name="curing_mileage" id="curing_mileage" style="width: 95%" placeholder="这里输入养护里程" title="养护里程"/></td>
				</tr>
				<tr>
