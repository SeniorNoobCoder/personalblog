...
<script type="text/javascript">
  ...
  <body>
   		<form action="${pageContext.request.contextPath}/system/dictionary/save.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
			<table width="90%">
		<tr>
				<td width="20%" align="right">上级节点：</td>
				<td><input type="text" name="parent_id" readonly="readonly" value="${pd.name }" style="width: 95%"/></td>
				</tr>
			<tr>
					<td width="20%" align="right">字典名称：</td><td><input maxlength="150" type="text" name="name" id="name" style="width: 95%" placeholder="这里输入名称" title="名称"/></td>
				</tr>
				<tr>
					<td width="20%" align="right">字典简称：</td>
					<td>
						<input maxlength="150" type="text" name="short_name" id="short_name" style="width: 95%" placeholder="这里输入简称" title="简称"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" name="type" id="type" style="width: 95%" placeholder="这里输入类型" title="类型"/></td>
				</tr>
				<tr>
					<td width="20%" align="right">排序：</td><td><input type="number" name="order_by" id="order_by" style="width: 95%" placeholder="这里输入序号" title="序号"/></td>
				</tr>
					<tr>
						<td width="20%" align="right">备注：</td>
						<td><textarea  name="remark" rows="3" style="width:95%;"></textarea>
						</td>
					</tr>					
			<tr>
