...
<html lang="en">
  ...
  <body>
    <form action="${pageContext.request.contextPath}/system/dictionary/update.do" name="roleForm" id="roleForm" method="post">
		<div id="zhongxin">
		<table width="90%">
		<tr>
				<td width="20%" align="right">上级菜单：</td>
				<td>
				<input type="text" readonly value="${pd.name }" style="width: 95%" placeholder="父节点" title="父节点"/>
				</td>
			</tr>
			<tr>
				<td width="20%" align="right">字典名称：</td><td><input maxlength="50"  readonly type="text" name="name" id="name" value="${p.name }" style="width: 95%" /></td>
			</tr>
			<tr>
				<td width="20%" align="right">字典简称：</td><td><input maxlength="50"  readonly type="text" name="short_name" id="short_name"  value="${p.short_name }"  style="width: 95%" /></td>
			</tr>
			
			<tr>
				<td width="20%" align="right">排序：</td>
				<td><input type="number" name="order_by"  id="order_by"  readonly value="${p.order_by }" style="width: 95%" onkeyup="this.value=this.value.replace(/\D/g,'')" onchange="this.value=this.value.replace(/\D/g,'')" maxlength="10" /></td>
			</tr>
			<tr>
				<td width="20%" align="right">备注：</td>
				<td>
					<textarea rows="5"  style="width: 95%;resize: none;"  readonly name="remark" id="remark">${p.remark}</textarea>
				</td>
			</tr>
			<tr>
