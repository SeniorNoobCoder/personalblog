		  ...
		  $("#cdForm").validate({
			    rules: {
			      login_name: {
			      	...
			      	rangelength:[4,18],
			      	remote: {
					    url: "${pageContext.request.contextPath}/system/user/checkLoginName.do",     //后台处理程序
					    type: "post",               //数据发送方式
...
//		      		},
  ...
  <body>
    <form action="${pageContext.request.contextPath}/system/user/save.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
