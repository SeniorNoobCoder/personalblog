...
<body>
<form action="${pageContext.request.contextPath}/server/category/save.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
        ...
        <div id="zhongxin">
            <table width="90%">
                ...
                <tr>
                    ...
                    <td><img alt="" src="${pd.image }" style="width: 80px;height: 80px;margin-bottom:10px;">
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="level" id="level" title="等级" value="${pd.level }"/>
                        <input type="text" name="parent_id" id="parent_id" title="父类id" value="${pd.parent_id }"/>
                    </td>
                </tr>
                <%--<tr>--%>
