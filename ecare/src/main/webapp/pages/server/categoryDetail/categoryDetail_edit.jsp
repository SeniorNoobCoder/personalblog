...
<body>
<form action="${pageContext.request.contextPath}/server/categoryDetail/updateCategory.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
            ...
            <table width="90%">
                ...
                <tr>
                    <td style="text-align: center;" colspan="2">
                        <input type="hidden" name="id" id="id" title="id" value="${pd.id }"/>
