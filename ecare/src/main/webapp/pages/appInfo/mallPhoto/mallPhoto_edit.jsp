...
<html lang="en">
  ...
  <body>
    <form action="${pageContext.request.contextPath}/appInfo/mallPhoto/update.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
		...
		<table width="90%">
			...
			<tr>
				...
				<td><input type="text" name="action_url" id="action_url" value="${p.action_url }" placeholder="这里输入跳转链接" title="跳转链接"/></td>
			</tr>
			<tr>
				<td width="20%" align="right">图片上传：<span style="color:#FF0000">*</span></td>
				<td><img alt="" src="${p.image_href }" style="height: 80px;margin-bottom:10px;"><br/>
				<input type="file" name="image_href" id="image_href" value="${p.image_href }"/></td>
			</tr>
			<tr>
					<td width="20%" align="right">排序：</td>
					<td><input type="number" name="order_by" id="order_by" value="${p.order_by }" style="width: 95%"
