...
<body>
<form action="${pageContext.request.contextPath}/appInfo/help/update.do" name="cdForm" id="cdForm" method="post" enctype="multipart/form-data">
        ...
        <div id="zhongxin">
            <table width="90%">
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="typeName"  id="typeName" value="business" style="width: 30px;margin-bottom: 8px" onclick="jqchk()" <c:if test="${p.type=='business'}">checked</c:if>/>商户
                        <input type="radio" name="typeName"  id="typeName" value="family" style="width: 30px;margin-bottom: 8px" onclick="jqchk()" <c:if test="${p.type=='family'}">checked</c:if>/>家人
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="editor" type="text/plain" style="width:500px;height:300px;" name="content">${p.content}</textarea>
                    </td>
                </tr>
                <tr>
