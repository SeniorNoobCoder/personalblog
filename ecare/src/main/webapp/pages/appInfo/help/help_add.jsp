        ...
        <div id="zhongxin">
            <table width="90%">
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="typeName"  id="typeName" value="business" style="width: 30px;margin-bottom: 8px" onclick="jqchk()" checked/>商户
                        <input type="radio" name="typeName"  id="typeName" value="family" style="width: 30px;margin-bottom: 8px" onclick="jqchk()"/>家人
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="editor" type="text/plain" style="width:500px;height:300px;" name="content"></textarea>
                    </td>
                </tr>
                <tr>
