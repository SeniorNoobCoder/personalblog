...
public class FamilyServiceImpl implements FamilyService {
	Logger logger = Logger.getLogger(FamilyServiceImpl.class);
	String mapperUrl = "com.ecare.web.customer.family.";
	@Autowired
	...
	public void clearTrash(PageData pd) {
		try {
			...
			if(flag.equals("clear")){
				...
				dao.deleteBatch(mapperUrl + "deleteFamilyDevice", ids);
				...
				dao.deleteBatch(mapperUrl + "deleteFamilyDevice", list);
			}
		} catch (Exception e) {
			logger.error(e);
			e.printStackTrace();
	...
	public List<PageData> findListBySn(PageData pd) {
		List<PageData> list = null;
		try {
			list = (List<PageData>) dao.findForList(mapperUrl + "findListBySn", pd);
		} catch (Exception e) {
			logger.error(e);
			e.printStackTrace();
		}
	...
	public List<PageData> findListByFamilyId(PageData pd) {
		List<PageData> list = null;
		try {
			list = (List<PageData>) dao.findForList(mapperUrl + "findListByFamilyId", pd);
		} catch (Exception e) {
			logger.error(e);
			e.printStackTrace();
		}
