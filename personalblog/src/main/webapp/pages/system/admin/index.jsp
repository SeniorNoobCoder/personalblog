	...
	<%@include file="top.jsp" %>
        ...
        <div class="info-news-blue">
            ...
            <div class="infobox-bot infobox-bot-blue">
                ...
                <div class="fr">
                	<a href=""><img src="${pageContext.request.contextPath}/ui/img/dj.png" /></a>
                </div>
            </div>
        </div>
        <div class="info-news-green">
        	<div class="infobox-top">
				...
				<div id="member-tab" class="tab-pane">
					<div class="clearfix">
						<div class="itemdiv memberdiv">
							<div class="user">
								<img alt="Bob's avatar" src="${pageContext.request.contextPath}/ui/avatars/user.jpg" />
							</div>
						...
						<div class="itemdiv memberdiv">
							<div class="user">
								<img alt="Joe's Avatar" src="${pageContext.request.contextPath}/ui/avatars/avatar2.png" />
							</div>
						...
						<div class="itemdiv memberdiv">
							<div class="user">
								<img alt="Jim's Avatar" src="${pageContext.request.contextPath}/ui/avatars/avatar.png" />
							</div>
						...
						<div class="itemdiv memberdiv">
							<div class="user">
								<img alt="Alex's Avatar" src="${pageContext.request.contextPath}/ui/avatars/avatar2.png" />
							</div>
						...
						<div class="itemdiv memberdiv">
							<div class="user">
								<img alt="Bob's Avatar" src="${pageContext.request.contextPath}/ui/avatars/avatar2.png" />
							</div>
						...
						<div class="itemdiv memberdiv">
							<div class="user">
								<img alt="Susan's Avatar" src="${pageContext.request.contextPath}/ui/avatars/avatar3.png" />
							</div>
						...
						<div class="itemdiv memberdiv">
							<div class="user">
								<img alt="Phil's Avatar" src="${pageContext.request.contextPath}/ui/avatars/avatar4.png" />
							</div>
						...
						<div class="itemdiv memberdiv">
							<div class="user">
								<img alt="Alexa's Avatar" src="${pageContext.request.contextPath}/ui/avatars/avatar1.png" />
							</div>
				...
				<div id="comment-tab" class="tab-pane">
					<div class="comments">
						<div class="itemdiv commentdiv">
							<div class="user">
								<img alt="Bob's Avatar" src="${pageContext.request.contextPath}/ui/avatars/avatar.png" />
							</div>
						...
						<div class="itemdiv commentdiv">
							<div class="user">
								<img alt="Jennifer's Avatar" src="${pageContext.request.contextPath}/ui/avatars/avatar1.png" />
							</div>
						...
						<div class="itemdiv commentdiv">
							<div class="user">
								<img alt="Rita's Avatar" src="${pageContext.request.contextPath}/ui/avatars/avatar3.png" />
							</div>
		...
		<div class="widget-body">
		 <div class="widget-main no-padding">
			...
			<div class="dialogs">
				...
				<div class="itemdiv dialogdiv">
					<div class="user">
						<img alt="John's Avatar" src="${pageContext.request.contextPath}/ui/avatars/avatar.png" />
					</div>
				...
				<div class="itemdiv dialogdiv">
					<div class="user">
						<img alt="Jim's Avatar" src="${pageContext.request.contextPath}/ui/avatars/avatar4.png" />
					</div>
